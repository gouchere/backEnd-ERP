...
@NamedQueries({
        @NamedQuery(name = "YvsBaseArticlesTemplate.findAll", query = "SELECT y FROM YvsBaseArticlesTemplate y WHERE y.societe =:societe ORDER BY y.designation"),
})
public class YvsBaseArticlesTemplate extends YvsEntity implements Serializable {
    ...
    public String toString() {
        return "com.erp.lymytz.api.model.base.article.param.YvsBaseArticlesTemplate[ id=" + id + " ]";
    }
}
